    ...
    <div class="home-page">
        ...
        <div class="col-lg-6 mx-auto zones mb">
            <zone-editable
                ...
                "
                @add="zone.distributions = $event.distributions"
                @delete="zone.distributions = $event.distributions"
                class="zone"
            />
        </div>
        ...
        <ul class="col-lg-6 mx-auto">
            <li>
                Add the percentage symbol to each distribution number while is
                not being edited
            </li>
            <li>The cancel button is not working</li>
            <li>
                Without refreshing the page, be able to edit all the
                distributions from a zone
            </li>
            <li>Be able to add more distributions</li>
            <li>Be able to remove distributions</li>
            <li>
                When the user is not able to save due to some error, the error
                must be showed
            </li>
            <li>
                The sum of all distributions must be ensured to be 100% in
                anyway
            </li>
            ...
            <li>
                Create a new field "updated_at" that is going to store the date
                when the name field change
            </li>
            <li>Show the updated_at field value near each zone name</li>
            <li>
                Add a way for the user to know that an element is being saved
            </li>
            <li>
                When the number of distributions is 5 or greater, the background
...
export default {
    ...
    mounted() {
        console.log(this.context.zones);
